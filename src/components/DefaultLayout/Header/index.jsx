              ...
              <Dropdown.Menu>
                <div className="nav-subdropdown-wrapper">
                  ...
                  <div className="nav-subdropdown">
                    ...
                    <NavDropdown.Item
                      as={Link}
                      to="/ecommerce-development-florida"
                      onClick={(e) => e.stopPropagation()}
                      target="_blank"
                    >
                      Ecommerce Development
                    ...
                    <NavDropdown.Item
                      as={Link}
                      to="/domain-registeration-florida"
                      onClick={(e) => e.stopPropagation()}
                      target="_blank"
                    >
                      Domain Registeration
                    ...
                    <NavDropdown.Item
                      as={Link}
                      to="/shopify-development-florida"
                      onClick={(e) => e.stopPropagation()}
                      target="_blank"
                    >
                      Shopify Development
                    ...
                    <NavDropdown.Item
                      as={Link}
                      to="/laravel-development-florida"
                      onClick={(e) => e.stopPropagation()}
                      target="_blank"
                    >
                      Laravel Development
